...
export function Topbar() {
  return (
    <div className="mb-6 flex items-center justify-between gap-4 rounded-2xl border border-white/10 bg-gradient-to-r from-white/[0.05] via-white/[0.03] to-white/[0.02] px-4 py-3 shadow-[0_16px_60px_-34px_rgba(56,189,248,0.5)] backdrop-blur-xl">
